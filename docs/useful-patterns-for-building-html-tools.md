...
- [icon-editor](link) is a custom 24x24 icon editor I built to help hack on icons for [the GitHub Universe badge](https://simonwillison.net/2025/Oct/28/github-universe-badge/). It persists your in-progress icon design in the URL so you can easily bookmark and share it.
